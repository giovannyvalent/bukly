        ...
        <div class="col-md-8">
            ...
            <div class="card card-default-white">
                <div class="card-header card-hearder-default">
                    <h1><i class="fa fa-tag"></i> Editar Quarto</h1>
                </div>
                <form action="{{route('room.update')}}" method="post" class="form-control">
                    <input type="hidden" name="id" value="{{$room->id}}">
                    @csrf
                    <div class="row">
                        <div class="col">
                            <label for="" class="">Quarto</label>
                          <input type="text" class="form-control" placeholder="Referência do quarto" name="name" value="{{$room->name}}">
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col">
                            <textarea name="description" id="description" cols="100" rows="10">{!! $room->description !!}</textarea>
                          </div>
                    </div>
